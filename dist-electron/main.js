...
function requireLib() {
  ...
  (function(module) {
    ...
    module.exports.encode = function encode3(str, encoding3, options) {
      str = "" + (str || "");
      var encoder = module.exports.getEncoder(encoding3, options);
      var res2 = encoder.write(str);
      var trail = encoder.end();
      return trail && trail.length > 0 ? Buffer2.concat([res2, trail]) : res2;
    };
    module.exports.decode = function decode2(buf, encoding3, options) {
      ...
      var decoder = module.exports.getDecoder(encoding3, options);
    ...
    module.exports.getCodec = function getCodec(encoding3) {
      ...
      var enc = module.exports._canonicalizeEncoding(encoding3);
      var codecOptions = {};
      while (true) {
    ...
    module.exports._canonicalizeEncoding = function(encoding3) {
      return ("" + encoding3).toLowerCase().replace(/:\d{4}$|[^0-9a-z]/g, "");
    };
    module.exports.getEncoder = function getEncoder(encoding3, options) {
      var codec = module.exports.getCodec(encoding3);
    ...
    module.exports.getDecoder = function getDecoder(encoding3, options) {
      var codec = module.exports.getCodec(encoding3);
    ...
    module.exports.enableStreamingAPI = function enableStreamingAPI(streamModule2) {
      ...
      module.exports.encodeStream = function encodeStream(encoding3, options) {
        return new module.exports.IconvLiteEncoderStream(module.exports.getEncoder(encoding3, options), options);
      };
      module.exports.decodeStream = function decodeStream(encoding3, options) {
        return new module.exports.IconvLiteDecoderStream(module.exports.getDecoder(encoding3, options), options);
      };
...
(function(exports$1) {
  var db = mimeDb;
  var extname2 = require$$0$4.extname;
  ...
  function extension(type3) {
    ...
    var match3 = EXTRACT_TYPE_REGEXP.exec(type3);
    var exts = match3 && exports$1.extensions[match3[1].toLowerCase()];
    if (!exts || !exts.length) {
      return false;
    }
    return exts[0];
...
function requireRead() {
  ...
  var hasBody = typeIsExports.hasBody;
  var { getCharset } = requireUtils();
  read_1 = read;
  function read(req2, res2, next, parse2, debug2, options) {
    ...
    if ((options == null ? void 0 : options.skipCharset) !== true) {
      encoding3 = getCharset(req2) || options.defaultCharset;
      if (!!(options == null ? void 0 : options.isValidCharset) && !options.isValidCharset(encoding3)) {
        debug2("invalid charset");
        next(createError2(415, 'unsupported charset "' + encoding3.toUpperCase() + '"', {
          charset: encoding3,
  ...
  function contentstream(req2, debug2, inflate) {
    ...
    var stream2 = createDecompressionStream(encoding3, debug2);
    req2.pipe(stream2);
    return stream2;
  }
...
function requireJson() {
  ...
  function json2(options) {
    ...
    const readOptions = {
      ...
      isValidCharset: (charset3) => charset3.slice(0, 4) === "utf-"
    };
    return function jsonParser(req2, res2, next) {
      read(req2, res2, next, parse2, debug2, readOptions);
    };
  }
...
function requireRaw() {
  ...
  var read = requireRead();
  var { normalizeOptions, passthrough } = requireUtils();
  raw_1 = raw;
  function raw(options) {
    ...
    return function rawParser(req2, res2, next) {
      read(req2, res2, next, passthrough, debug2, readOptions);
    };
  }
  return raw_1;
}
...
function requireText() {
  ...
  function text(options) {
    ...
    return function textParser(req2, res2, next) {
      read(req2, res2, next, passthrough, debug2, normalizedOptions);
    };
  }
  return text_1;
}
...
function requireUrlencoded() {
  ...
  function urlencoded(options) {
    ...
    const readOptions = {
      ...normalizedOptions,
      // assert charset
      isValidCharset: (charset3) => charset3 === "utf-8" || charset3 === "iso-8859-1"
    };
 ...
 */
(function(exports$1) {
  var { METHODS: METHODS2 } = require$$2$1;
  var contentType3 = contentType$1;
  var etag2 = etag_1;
  var mime2 = mimeTypes;
...
function parse$4(str, options = {}) {
  ...
  while (index < chars.length) {
    ...
    if (type3) {
      tokens.push({ type: type3, index: index++, value });
    } else if (value === "\\") {
...
function compile(path3, options = {}) {
  ...
  const data = typeof path3 === "object" ? path3 : parse$4(path3, options);
...
function pathToRegexp(path3, options = {}) {
  ...
  for (const input of pathsToArray(path3, [])) {
    const data = typeof input === "object" ? input : parse$4(input, options);
    for (const tokens of flatten$2(data.tokens, 0, [])) {
...
function* flatten$2(tokens, index, init) {
  ...
  if (token.type === "group") {
    for (const seq of flatten$2(token.tokens, 0, init.slice())) {
...
const deprecate$2 = depd_1("router");
  ...
  try {
    ...
    if (isPromise$1(ret)) {
      if (!(ret instanceof Promise)) {
        deprecate$2("handlers that are Promise-like are deprecated, use a native Promise instead");
      }
...
const Layer$1 = layer;
const { METHODS: METHODS$1 } = require$$2$1;
...
function processParams(params, layer2, called, req2, res2, done) {
  ...
  function paramCallback(err) {
    ...
    try {
      ...
      if (isPromise(ret)) {
        if (!(ret instanceof Promise)) {
          deprecate$1("parameters that are Promise-like are deprecated, use a native Promise instead");
        }
        ret.then(null, function(error2) {
...
req.acceptsLanguages = function(...languages2) {
...
var mime = mimeTypes;
var path2 = path$3;
var pathIsAbsolute = path$3.isAbsolute;
...
const { Buffer: Buffer$1 } = require$$7$1;
...
function requireServeStatic() {
  ...
  var resolve3 = require$$0$4.resolve;
  var send4 = send_1;
...
function createWindow() {
  win = new BrowserWindow({
    ...
    webPreferences: {
      preload: path$3.join(__dirname$1, "preload.js")
    }
  });
